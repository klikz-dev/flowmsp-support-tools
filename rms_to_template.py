...
def reformat_records(fp, limit):
    ...
    for recnum, irec in enumerate(r):
        ...
        orec["Street Address"] = irec["Address1"]
        ...
        orec["Owner Phone"] = irec["Phone"]
        
        # property_class, prop_use, property
        # orec["Notes"] = make_note(irec)
        orec["Storey Above"] = irec["NumberOfFloors"]

        if irec["BasementPresent"].lower() == "yes":
            orec["Storey Below"] = 1
